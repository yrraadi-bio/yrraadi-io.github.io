...
const COPY = {
  ...
  byBlock: {
    ...
    panel: (index) => `<span>Every card is one gene set this feature reproduces on held-out tissue, and the set selected
      ...
      can be selected, greyed or not. The list opens folded to the strongest few cards the rule kept, and the
      control beside the heading opens it on all of them.</span>
  ...
  blocks: {
    ...
    foldTitle: "Folded, the list holds the strongest few cards the rule kept and the one selected. Opened, it holds"
      + " every card, greyed ones included, ranked by |held-out r|.",
